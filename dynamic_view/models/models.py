...
class DynamicView(models.TransientModel):
    ...
    field_view_definition = '<field name="%(t_date_name)s" string="%(date_name)s"/>'
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False,
        ...
        if view_type == 'tree':
            ...
            for i in range(10):
                ...
                self._add_field(t_date_name, DynamicView.get_field_states())
                date_node = etree.fromstring(
                    DynamicView.field_view_definition % {
                        't_date_name': t_date_name, 'date_name': date_name})
